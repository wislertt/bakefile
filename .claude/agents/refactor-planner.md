...
Remember to check for any project-specific guidelines in .claude/CLAUDE.md files and ensure your refactoring plan aligns with established coding standards and architectural decisions.
