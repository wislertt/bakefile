...
class TestResetAllLoggingStates:
    ...
    def test_clears_root_logger_handlers(self, reset_all_logger_state: None) -> None:
    ...
    def test_resets_root_logger_level(self, reset_all_logger_state: None) -> None:
    ...
    def test_clears_child_logger_handlers(self, reset_all_logger_state: None) -> None:
    ...
    def test_resets_child_logger_level(self, reset_all_logger_state: None) -> None:
...
class TestPrettyLogFormatter:
    ...
    def test_pretty_log_formatter_returns_string(self, reset_all_logger_state: None) -> None:
