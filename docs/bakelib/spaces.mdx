...
A custom Space is a Bakebook like any other - publish it as a package to share it across projects. See [Reuse tasks across projects](/concepts/sharing-tasks).
