...
- [Examples](/examples/simple) - complete bakefiles to copy, from a standalone single file to a full Python package
- [Common errors and fixes](/troubleshooting) - exact error messages and how to fix them
